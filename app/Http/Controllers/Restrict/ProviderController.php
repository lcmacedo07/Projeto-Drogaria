...
class ProviderController extends StandardController {
    ...
    protected $page;
    protected $gate;
    protected $nomeView = 'restrict.providers';
    protected $redirectIndex = '/restrict/providers';

    public function __construct(Providers $model, Citys $citys, Request $request) {
        $this->model = $model;
        $this->citys = $citys;
