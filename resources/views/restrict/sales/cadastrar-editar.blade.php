        ...
        <div class='row'>
            <div class='input-field col-md-3'>
                ...
                <div class="input-group">
                    ...
                    {!! Form::date('sal_date', null, ['required' => 'yes', 'min' => '5', 'placeholder' => 'Insira a Data da Venda', 'class' => 'form-control']) !!}
            ...
            <div class='input-field col-md-3'>
                ...
                <div class="input-group">
                    ...
                    {!! Form::number('sal_amount', null, ['required' => 'yes', 'min' => '5','placeholder' => 'Insira a Quantidade de Venda', 'class' => 'form-control']) !!}
            ...
            <div class='input-field col-md-3'>
                ...
                <div class="input-group">
                    ...
                    {!! Form::number('sal_exit_price', null, ['required' => 'yes', 'min' => '1', 'placeholder' => 'Insira o Preço da Venda', 'class' => 'form-control']) !!}
            ...
            <div class='input-field col-md-3'>
                ...
                <div class="input-group">
                    ...
                    {!! Form::number('sal_cost_price', null, ['required' => 'yes', 'min' => '1', 'placeholder' => 'Insira o Preço de Custo', 'class' => 'form-control']) !!}
