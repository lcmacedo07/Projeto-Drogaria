...
<div class="row m-t-20">
    <div class='input-field col-md-4'>
        ...
        <div class="input-group">
            ...
            {!! Form::text('iteme_lot', null, ['required' => 'yes', 'min' => '5', 'maxlength' => '30', 'placeholder' => 'Insira o Lote', 'class' => 'form-control']) !!}
    ...
    <div class='input-field col-md-4'>
        ...
        <div class="input-group">
            ...
            {!! Form::number('iteme_amount', null, ['required' => 'yes', 'min' => '1','placeholder' => 'Insira a Quantidade', 'class' => 'form-control']) !!}
    ...
    <div class='input-field col-md-4'>
        ...
        <div class="input-group">
            ...
            {!! Form::number('iteme_value', null, ['required' => 'yes', 'min' => '1', 'placeholder' => 'Insira o Valor', 'class' => 'form-control']) !!}
