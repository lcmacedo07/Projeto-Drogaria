                ...
                <div class='table-responsive alt-table'>
                    <table id='table2' class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td> {{ $registro->itemi_codigo }} </td>
                                <td> {{ $registro->prod_codigo }} </td>
                                <td> {{ $registro->inp_codigo }} </td>
                                <td> {{ $registro->itemi_lot }} </td>
                                <td> {{ $registro->itemi_amount }} </td>
                                <td> {{ $registro->itemi_value }} </td>
                                <td>
                                    <div class='btn-group'>
<!--                                        <a href='#' class='btn blue-black-bg white'  data-toggle='tooltip' data-placement='top' title='Delete'
                                           onclick="deletar('{{url("/restrict/$page/$registro->itemi_codigo")}}')" id='urlDeletar' >
                                            <i class='glyphicon glyphicon-trash'></i>
                                        </a>-->
                                        <a href='{{url("/restrict/$page/$registro->itemi_codigo/deletar")}}' 
                                        ...
                                        <a href='{{url("/restrict/$page/$registro->itemi_codigo/edit")}}' 
