            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class='input-field col-md-6'>
                        ...
                        <div class="input-group">
                            <select name='input_id' class='form-control'>
                                @foreach($inputs as $input)
                                <option 
                                    @if(isset($data->input_id) && ($data->id==$input->id)) @php echo 'selected'; @endphp @endif 
                                    value="{{$input->id}}" >
                                    {{$input->id}}
                            </option>
                            @endforeach
                        ...
                        <span class='text-danger'> {{ $errors->first('input_id') }} </span>
                        @endif
                    </div>
                </div>
            </div>     
