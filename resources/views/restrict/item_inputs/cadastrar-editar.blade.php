        ...
        <div class="col-md-12">
            ...
            <div class="row m-t-20">
                <div class='input-field col-md-4'>
                    <label>LOTE</label>
                    <div class="input-group">
                        {!! Form::text('itemi_lot', null, ['required' => 'yes', 'min' => '5', 'maxlength' => '30', 'class' => 'form-control']) !!}
                ...
                <div class='input-field col-md-4'>
                    ...
                    <div class="input-group">
                        {!! Form::number('itemi_amount', null, ['required' => 'yes', 'min' => '1','class' => 'form-control']) !!}
                ...
                <div class='input-field col-md-4'>
                    <label>VALOR</label>
                    <div class="input-group">
                        {!! Form::number('itemi_value', null, ['required' => 'yes', 'min' => '1','class' => 'form-control']) !!}
