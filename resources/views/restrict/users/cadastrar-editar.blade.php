                ...
                <div class="card-body">
                    ...
                    <div class='row m-t-20'>
                        ...
                        <div class='input-field col-md-4'>
                            <label>RG</label>
                            <div class="input-group">
                                {!! Form::text('rg', null, ['required' => 'yes', 'min' => '5', 'maxlength' => '30','class' => 'form-control']) !!}
                                @if ($errors->has('rg'))
                    ...
                    <div class='row m-t-20'>
                        <div class='input-field col-md-4'>
                            <label>CELULAR</label>
                            <div class="input-group">
                                {!! Form::text('cellphone', null, ['data-mask' => '(00)00000-0000','maxlength' => '16','class' => 'form-control']) !!}
                        ...
                        <div class='input-field col-md-4'>
                            ...
                            <div class="input-group">
                                {!! Form::text('cellphone2', null, ['data-mask' => '(00)00000-0000','maxlength' => '16','class' => 'form-control']) !!}
                        ...
                        <div class='input-field col-md-4'>
                            <label>TIPO</label>
                            <div class="input-group">
                                {!! Form::text('type', null, ['maxlength' => '20', 'class' => 'form-control']) !!}
                                @if ($errors->has('type'))
