            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class='input-field col-md-6'>
                        ...
                        <div class="input-group">
                            {!! Form::text('provider', null, ['required' => 'yes', 'min' => '5', 'maxlength' => '200', 'class' => 'form-control']) !!}
                ...
                <div class="row m-t-20">    
                    <div class='input-field col-md-3'>
                        ...
                        <div class="input-group">
                            {!! Form::text('address', null, ['required' => 'yes', 'min' => '5', 'maxlength' => '60', 'class' => 'form-control']) !!}
                    ...
                    <div class='input-field col-md-3'>
                        <label>BAIRRO</label>
                        <div class="input-group">
                            {!! Form::text('neighborhood', null, ['required' => 'yes', 'min' => '5', 'maxlength' => '40',  'class' => 'form-control']) !!}
                    ...
                    <div class='input-field col-md-3'>
                        <label>CEP</label>
                        <div class="input-group">
                            {!! Form::text('zip_code', null,['data-mask' => '00000-000','required' => 'yes', 'min' => '5', 'maxlength' => '14',  'class' => 'form-control']) !!}
                ...
                <div class="row m-t-20">
                    <div class='input-field col-md-3'>
                        <label>CONTATO</label>
                        <div class="input-group">
                            {!! Form::text('contact', null, ['required' => 'yes', 'min' => '5', 'maxlength' => '50', 'class' => 'form-control']) !!}
                    ...
                    <div class='input-field col-md-3'>
                        <label>INCS</label>
                        <div class="input-group">
                            {!! Form::text('insc', null, ['required' => 'yes', 'min' => '5', 'maxlength' => '120', 'class' => 'form-control']) !!}
                            @if ($errors->has('insc'))
